...
<html>
    <head>
        ...
        <jqval:resources />
        <jqvalui:resources />
        <jqvalui:renderValidationScript for="com.jdonee.Job" not="companyResponsible,closed,dateCreated,lastUpdated" form="jobForm" errorClass="invalid" validClass="success" onsubmit="false"  renderErrorsOnTop="true" />
    </head>
    <body>
        ...
        <div class="body">
            ...
            <g:form action="save" name="jobForm">
