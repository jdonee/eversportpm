	...
	def init = { servletContext ->
		switch(GrailsUtil.environment){
			case "development":
				...
				new Requestmap(description:'个人考核管理',url: '/personalPerformance/**', configAttribute: 'ROLE_ADMIN,ROLE_USER',customed:true).save()
				...
				def job1=new Job(name:'市场部经理',code:'020202',user:testUser1,company:company2,department:department5,jobType:jobType4,companyResponsible:true)
				...
				def job6=new Job(name:'人事总监',code:'010201',user:testUser6,company:company1,department:department2,jobType:jobType1)
